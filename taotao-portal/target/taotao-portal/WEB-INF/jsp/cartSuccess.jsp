...
<link ref="stylesheet" type="text/css"
	href="/css/base.css">
<link ref="/css/taotao.css" type="text/css"
	href="stylesheet">
<title>商品已成功加入购物车</title>
<style id="style-1-cropbar-clipper" >
/* Copyright 2014 Evernote Corporation. All rights reserved. */
.en-markup-crop-option{
	top: 18px !important;
	left: 50% !important;
...
.en-markup-crop-option div div:first-of-type{
			...
			<div class="m" id="succeed">
				...
				<div class="success">
					...
					<span id="initCart_next_go"><a class="btn-1"
						href="/cart/cart.html"
						id="GotoShoppingCart">购物车结算</a><span class="ml10">您还可以<a
